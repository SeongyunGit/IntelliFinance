  ...
  <div>
    ...
    >
      ...
      <div>
        ...
        <p class="text-gray-800 text-sm mt-2 text-gray-500">{{ comment.created_at }}</p>
      </div>
      ...
      <button
        ...
        class="ml-4 bg-red-500 text-white py-2 px-4 rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:ring-red-300"
      >
        삭제
      </button>
    </div>
    ...
    <div v-if="store.mPK" class="p-6 bg-white shadow rounded-md">
      ...
      <button
        @click="saveComment"
        class="mt-4 bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300"
      >
        저장
      </button>
    </div>
