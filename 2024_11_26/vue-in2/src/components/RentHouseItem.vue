<template>
  <div v-if="bank.type_a=='rentHouseLoan'" class="bg-white rounded-lg shadow-md p-6 space-y-6 relative min-h-[300px]">
    <!-- 은행 이름과 상품명 -->
    <div>
    ...
    <div class="border-t border-gray-200 pt-4 pb-16 space-y-3">
      <div class="text-sm text-gray-700">
        ...
        <p><span class="font-medium text-blue-600">6개월 초과:</span> 주택 담보 대출</p>
      </div>
    </div>
