    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('installment_product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='options', to='SavingsPlan.installmentproduct')),
            ],
        ),
    ]
